...
public slots:
    ...
    void setRootIndex(QString name);
    void setRootIndexToParent();
    bool isRoot();
    int getParentIndex();
...
private slots:
    ...
    void resetApps();
    void buildMenuTreeModel();
    MenuItem* addCategory(MenuItem *parent, QString name, QString icon, QString groups);
private:
